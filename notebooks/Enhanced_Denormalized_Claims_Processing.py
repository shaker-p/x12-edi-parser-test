...
def get_837i_schema():
    ...
    StructField("patient_response_entity_identifier_code", StringType(), True),
    StructField("patient_name_last_or_organization_name", StringType(), True),
    ...
    StructField("subscriber_entity_relationship_code", StringType(), True),
    StructField("subscriber_response_entity_identifier_code", StringType(), True),
    StructField("subscriber_name_last_or_organization_name", StringType(), True),
